...
import { Users, Calendar, ChevronLeft, ChevronRight, Heart, MessageCircle } from "lucide-react";
                ...
                <div className="flex flex-col items-start flex-1 min-w-0">
                  ...
                  <div className="mt-1.5 flex items-center gap-2 text-[10px] text-white/45">
                    <span className="inline-flex items-center gap-1">
                      ...
                      {entry.activitySummary?.reaction || 0}
                    </span>
                    <span className="inline-flex items-center gap-1">
                      <MessageCircle className="h-2.5 w-2.5" />
                      {(entry.activitySummary?.comment || 0) +
                        (entry.activitySummary?.reply || 0)}
                    </span>
                    {(entry.unreadActivityCount || 0) > 0 && (
